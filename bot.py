...
sys.path.insert(1, '/home/localadmin/Mercybot/cogs/music')
import config
import asyncpg
...
description = """
Hello! I am a bot written by The Support Hero to provide some nice utilities.
"""
...
class Mercybot(commands.AutoShardedBot):
    ...
    async def setup_hook(self) -> None:
        ...
        self.owner_id = 450044263720288257
