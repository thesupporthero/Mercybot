...
from .utils.paginator import MercyPages
import discord
...
class GroupHelpPageSource(menus.ListPageSource):
    ...
    async def format_page(self, menu: MercyPages, commands: list[commands.Command]):
...
class HelpSelectMenu(discord.ui.Select['HelpMenu']):
    def __init__(self, entries: dict[commands.Cog, list[commands.Command]], bot: Mercybot):
        super().__init__(
...
class FrontPageSource(menus.PageSource):
    ...
    def format_page(self, menu: HelpMenu, page: Any):
        ...
        embed.add_field(
            name='Support Server',
            value='For more help, contact thesupporthero',
            inline=False,
        )
        ...
        if self.index == 0:
            embed.add_field(
                name='Who are you?',
                value=(
                    "I'm a bot made by thesupporthero. I'm the oldest running Discord bot! I've been running since "
                    ...
                    "I'm also open source. You can see my code on [GitHub](https://github.com/thesupporthero/Mercybot)!"
                ),
                inline=False,
            )
        elif self.index == 1:
...
class Meta(commands.Cog):
    ...
    async def hello(self, ctx: Context):
        ...
        await ctx.send('Hello! I\'m a robot! thesupporthero made me.')
    ...
    async def source(self, ctx: Context, *, command: str = None):
        ...
        or by spaces.
        """
        source_url = 'https://github.com/Thesupporthero/Mercybot'
        branch = 'rewrite'
        if command is None:
